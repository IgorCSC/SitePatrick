...
Dois referenciais $X_1$, $T_1$ <span style="color: #006eaf;">(azul)</span> e $X_2$, $T_2$ <span style="color: #41b23b;">(verde)</span> não conservam a simultaneidade dos acontecimentos, tampouco conservam a posição no espaço. No entanto, para o objeto $A$ que se move em direção a $B$, a velocidade medida em cada referencial será a mesma, ou seja (5,68/5,68 = 1 no referencial <span style="color: #41b23b;">verde</span> e 4/4 = 1 no referencial azul).
...
Em relação ao espaço, o referencial $X_1$, $T_1$ <span style="color: #006eaf;">(azul)</span> desloca-se em relação ao referencial $X_2$, $T_2$ <span style="color: #41b23b;">(verde)</span>. De fato, o objeto $C$ fica imóvel no referencial azul e desloca-se 3,42 metros para direita em 10 segundos no referencial <span style="color: #41b23b;">verde</span>.
...
Em relação ao tempo, os acontecimentos $A$ e $B$ são simultâneos no referencial azul $T_1$($A$) = $T_1$($B$) = 3, mas, correspondem a instantes diferentes $T_2$($A$) = 4,65 e $T_2$($B$) = 7,19 no referencial <span style="color: #41b23b;">verde</span>. ângulos medem 20 graus o que corresponde a uma velocidade $V$ = sen 20°=0,342.
